...
async function wikipediaSummaryArtwork(input) {
  ...
  const response = await fetch(`https://en.wikipedia.org/api/rest_v1/page/summary/${slug}`, {
    headers: { Accept: 'application/json', 'User-Agent': 'RingsideArchive/5.5.0 (+https://ringside-archive.vercel.app/)', 'Api-User-Agent': 'RingsideArchive/5.5.0 (+https://ringside-archive.vercel.app/)' },
...
async function proxyArtworkAsset(asset, res) {
  ...
  const response = await fetch(asset, {
    headers: {
      ...
      'User-Agent': 'RingsideArchive/5.5.0 (+https://ringside-archive.vercel.app)',
