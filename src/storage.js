...
function normalizePlexData(value) {
  ...
  return {
    ...
    cloudConnected: Boolean(value?.cloudConnected),
    scannedAt: value?.scannedAt || null,
    importDiagnostics: value?.importDiagnostics && typeof value.importDiagnostics === 'object' ? value.importDiagnostics : null,
