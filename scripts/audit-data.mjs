...
const [promotions,programmes,events,recommendations,customRecords,eventDetails,artworkCatalog,core]=await Promise.all(['promotions','programmes','major-events','recommendations','custom-records','event-details','artwork-catalog','core'].map(read));
