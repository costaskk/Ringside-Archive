...
const required=[
  ...
  'src/app.js','src/styles.css','src/storage.js','src/tvmaze.js','src/utils.js','src/records.js','src/integrations.js','src/cloud.js','src/plex-indexeddb.js',
  ...
  'tools/export-plex-library.ps1','tools/upload-artwork-r2.ps1','tools/upgrade-preserve-r2.ps1','scripts/cache-artwork-assets.mjs','docs/CLOUDFLARE-R2-ARTWORK.md','docs/PLEX-CATALOGUE-IMPORT.md','.github/workflows/publish-artwork-r2.yml','scripts/audit-plex-export.mjs','scripts/audit-free-links.mjs','scripts/async-ui-smoke.mjs','scripts/plex-match-smoke.mjs','scripts/plex-storage-smoke.mjs','scripts/runtime-smoke.mjs','scripts/performance-smoke.mjs','scripts/build-core.mjs','scripts/cloud-smoke.mjs','scripts/integration-smoke.mjs','scripts/sync-tvmaze.mjs','scripts/discover-tvmaze.mjs','scripts/scan-artwork.mjs','scripts/enrich-event-details.mjs'
];
...
for(const ref of ['./storage.js','./tvmaze.js','./utils.js','./records.js','./integrations.js','./cloud.js','./plex-indexeddb.js'])if(!app.includes(ref))throw new Error(`app.js is missing import ${ref}`);
...
if(packageJson.version!=='5.8.0')throw new Error(`Expected package version 5.8.0, found ${packageJson.version}.`);
