...
const required=[
  ...
  'tools/export-plex-library.ps1','scripts/audit-plex-export.mjs','scripts/audit-free-links.mjs','scripts/async-ui-smoke.mjs','scripts/plex-match-smoke.mjs','scripts/plex-storage-smoke.mjs','scripts/runtime-smoke.mjs','scripts/performance-smoke.mjs','scripts/build-core.mjs','scripts/cloud-smoke.mjs','scripts/integration-smoke.mjs','scripts/sync-tvmaze.mjs','scripts/discover-tvmaze.mjs','scripts/scan-artwork.mjs','scripts/enrich-event-details.mjs'
];
...
if(packageJson.version!=='5.5.0')throw new Error(`Expected package version 5.5.0, found ${packageJson.version}.`);
...
for(const marker of ['ringside-archive-v5.5.0','networkFirst','url.pathname.startsWith(\'/api/\')'])if(!serviceWorker.includes(marker))throw new Error(`Service worker is missing reliability marker: ${marker}`);
