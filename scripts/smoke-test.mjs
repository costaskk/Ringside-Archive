...
if(packageJson.version!=='5.6.0')throw new Error(`Expected package version 5.6.0, found ${packageJson.version}.`);
...
for(const marker of ['ringside-archive-v5.6.0','networkFirst','url.pathname.startsWith(\'/api/\')'])if(!serviceWorker.includes(marker))throw new Error(`Service worker is missing reliability marker: ${marker}`);
